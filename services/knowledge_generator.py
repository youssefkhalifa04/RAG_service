...
from utils.employee import get_average_comparison, get_single_employee_deeds , generate_employee_statement
from utils.machine import  generate_machine_statement
    ...
    def generate_knowledge(self):
        ...
        for factory_id in queue:
            ...
            if len(logs) == 0:
                ...
                emp_mach_codes = set((log['employee']['code'], log['machine']['code']) for log in logs)
                stats = {
                ...
                for emp_code, machine_code in emp_mach_codes:
                    ...
                    mach_stmt = generate_machine_statement(machine_code, deeds , stats, avg_comp)
                    statement = generate_employee_statement(emp_code, machine_code, deeds , stats, avg_comp)
                    try:
